...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            //builder.Entity<ApplicationUser>().Property(p => p.VerifyStatus).HasConversion( v => v.ToString(), v => (EnumStatus)Enum.Parse(typeof(EnumStatus), v));
            ...
            builder.Entity<UserSession>().ToTable($"App{nameof(this.UserSessions)}");
        }
