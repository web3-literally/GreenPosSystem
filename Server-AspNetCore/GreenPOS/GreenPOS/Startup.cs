...
using GreenPOS.Authorization;
using GreenPOS.Helpers;
using GreenPOS.ViewModels;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("GreenPOS")));
            ...
            */
            ...
            services.AddIdentityServer()
              ...
              {
                  options.ConfigureDbContext = builder => builder.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], sql => sql.MigrationsAssembly("GreenPOS"));
              })
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - GreenPOS";
